...
The simulator accepts operation `op-001`, records one synthetic effect, and then deterministically loses its acknowledgement. The workflow result is `COMPLETION_UNKNOWN`, not success and not an invitation to retry blindly.
